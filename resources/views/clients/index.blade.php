  ...
  <div class="w-full mx-auto bg-slate-900 dark:bg-gray-100 flex flex-col h-screen">
    <div class="flex justify-between items-center mb-4 p-4 dark:bg-white bg-gray-800 w-full">
      ...
      <div class="flex flex-col gap-2 md:flex-row pr-4">
        <a href="{{ route('clients.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 block">Add
          client</a>
    ...
    <div class="container flex flex-col lg:flex-row p-4 pt-0 justify-between">
      <div class="container flex flex-col lg:flex-row gap-2">
        <div class="flex flex-row items-center">
          <p class="bg-slate-800 dark:bg-gray-200 w-full lg:w-  fit px-2 py-2 rounded-l-lg ">clients number
            : </p>
          <p
      ...
      <table class="min-w-full shadow-md">
        <thead class="bg-slate-800 text-white dark:bg-gray-200 dark:text-black rounded-md lg:sticky top-0">
          <tr>
            ...
            <th class="py-2 px-4 text-start">First Name</th>
            <th class="py-2 px-4 text-start">Last Name</th>
            <th class="py-2 px-4 text-start">Phone Number</th>
            <th class="py-2 px-4 text-start">City</th>
            <th class="py-2 px-4 text-start">Birthday</th>
        ...
        <tbody>
          @foreach ($clients as $item)
            <tr class="hover:bg-slate-700 dark:hover:bg-gray-300" id="item-{{ $item->id }}">
              ...
              <td class="py-2 px-4">{{ $item->birthday }}</td>
          ...
          <div class="dark:bg-white bg-gray-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 class="text-base font-semibold dark:text-gray-900 text-gray-100" id="modal-title">Delete the client
                </h3>
                <div class="mt-2">
                  <p class="text-sm dark:text-gray-500 text-gray-300">Are you sure you want to delete this client? This
